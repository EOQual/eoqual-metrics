...
def gmsd(GT, P, rescale=True, returnMap=True):
    """
    Compute Gradient Magnitude Similarity Deviation (GMSD) IQA metric
    (Xue et al., 2014). This implementation is a translation of the
    ...
    notice à conserver. Algorithme par défaut de `gmsd`.
    ...
    aveY1 = signal.convolve2d(scl * GT, ukrn, mode='same', boundary='symm')
    aveY2 = signal.convolve2d(scl * P, ukrn, mode='same', boundary='symm')
