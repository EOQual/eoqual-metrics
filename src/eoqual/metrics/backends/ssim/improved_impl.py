...
__license__ = "GPL"
# STATUT LICENCE (voir THIRD_PARTY_LICENSES.md, racine du dépôt) : ce fichier
# N'EST PAS sous la licence MIT du reste d'eoqual-metrics (GPL auto-déclaré
# ci-dessus). Algo optionnel `ssim_2` (non par défaut, 🟡).
