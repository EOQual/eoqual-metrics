...
GPL-3.0, comme indiqué ci-dessus. Ce fichier N'EST PAS sous la licence MIT
du reste d'eoqual-metrics. Algo optionnel `ssim_3` (non par défaut, 🟡).
"""
...
def ssim(img1, img2, C1=0.01**2, C2=0.03**2, MAP=False):
    ...
    if MAP:
        return numpy.mean(ssim_map), ssim_map
    else:
        return numpy.mean(ssim_map)

 
# FIXME there seems to be a problem with this code
def ssim_exact(img1, img2, sd=1.5, C1=0.01**2, C2=0.03**2, MAP=False):
