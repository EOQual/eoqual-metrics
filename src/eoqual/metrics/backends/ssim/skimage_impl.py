...
STATUT LICENCE (voir THIRD_PARTY_LICENSES.md, racine du dépôt) : la source
mubeta06/python est GPL-3.0/LGPL-3.0 (HLVC, cité en second, est BSD-3-Clause).
Ce fichier N'EST PAS sous la licence MIT du reste d'eoqual-metrics. Algos
optionnels `ssim_1`/`msssim_1` (non par défaut, 🟡).
"""
import sys
import numpy as np
import pylab
