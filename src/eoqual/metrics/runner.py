    ...
    * :attr:`results_accumulated` — historique des valeurs scalaires sur
    ...
    def compute(
        ...
        for entry in self.results:
            ...
            # NOTE: try/except volontairement désactivé tant que la librairie
            # n'est pas totalement débuguée : laisser l'exception remonter
            # donne une trace complète (fichier/ligne/cause), bien plus utile
            # pour diagnostiquer que value=None. À ne réactiver que lorsque
            # la robustesse sur de gros batchs deviendra prioritaire par
            # rapport au diagnostic fin.
#            try:
