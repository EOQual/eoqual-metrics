...
suivre. Utilise directement l'API `sewar` plutôt que le registre
eoqual-metrics (voir `fr/*.py`, algo="sewar" pour l'équivalent intégré).
Conservé pour mémoire. Pour un usage réel, voir plutôt `examples/`.
